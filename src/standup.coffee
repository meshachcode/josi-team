...
#
# Commands:
#   hubot stop standup - Stops the meeting
#   hubot standup for <group> - Starts the standup
#   hubot (that's it|next|next person|done) - Moves to the next person
#   hubot skip <person> - Skips the person
#
# Author:
# 
#
